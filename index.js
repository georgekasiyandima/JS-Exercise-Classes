...
class Car {
  ...
  drive(distance) {
    if (this.tank === 0) {
      ...
      let reducedTank = distance / this.milesPerGallon;
      this.tank -= reducedTank;
    }
  }
}
...
class Student extends Lambdasian {
  constructor(object, previousBackground, className, favSubjects) {
    super(object.name, object.age, object.location);
  ...
  listSubjects() {
    return `Today we are learning about ${this.favSubjects}`;
  }
